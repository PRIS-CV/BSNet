...
if __name__=='__main__':
    ...
    if params.stop_epoch == -1: 
        if params.method in ['baseline', 'baseline++'] :
            if params.dataset in ['omniglot', 'cross_char']:
                params.stop_epoch = 5
            elif params.dataset in ['CUB', 'cars', 'aircraft', 'dogs']:
    ...
    if params.method in ['baseline', 'baseline++'] :
    ...
    elif params.method in ['protonet','matchingnet','relationnet', 'relationnet_softmax', 'CosineBatch', 'OurNet', 'maml', 'maml_approx']:
        ...
        if params.method == 'protonet':
        ...
        elif params.method in ['relationnet', 'relationnet_softmax', 'CosineBatch', 'OurNet']:
            ...
            loss_type = 'mse' if params.method in ['relationnet', 'CosineBatch', 'OurNet'] else 'softmax'
